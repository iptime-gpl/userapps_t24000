...
unsigned int mv_98DX3xx_read_reg(unsigned int portNumber, unsigned int switch_reg, unsigned int *switch_val)
{
...
unsigned int mv_98DX3xx_write_reg(unsigned int portNumber, unsigned int switch_reg, unsigned int switch_val)
{
	unsigned int reg_val, timeout;
	unsigned int msb, lsb;
